      ...
      <section className="max-w-frame mx-auto bg-[#F0F0F0] px-6 pb-6 pt-10 md:p-[70px] rounded-[40px] text-center">
        <motion.h2
          ...
          className={cn([
            ...
            'text-[32px] leading-[36px] md:text-5xl mb-8 md:mb-14 capitalize text-primary'
          ])}>
          BROWSE BY CATEGORY
        </motion.h2>
        <motion.div
          ...
          <DressStyleCard
            title="Living Room"
            url="/shop#living-room"
            className="md:max-w-[260px] lg:max-w-[360px] xl:max-w-[407px] h-[190px] bg-[url('/images/category.avif')]"
          />
          <DressStyleCard
            title="Bedroom"
            url="/shop#bedroom"
            className="md:max-w-[684px] h-[190px] bg-[url('/images/category.avif')]"
          />
        </motion.div>
        <motion.div
          initial={{ y: '100px', opacity: 0 }}
