...
const NewsLetterSection = () => {
  return (
    <div
      className="
    bg-primary
    relative grid grid-cols-1 md:grid-cols-2 py-9 md:py-11 px-6 md:px-16 max-w-frame mx-auto bg-black rounded-[20px]">
      <p
        className={cn([
      ...
      <div className="flex items-center">
        <div className="flex flex-col max-w-[349px] mx-auto">
          ...
          <Button
            variant="secondary"
            className="text-sm sm:text-base font-medium bg-white h-12 rounded-full px-4 py-3 bg-secondary"
